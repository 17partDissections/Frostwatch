...
namespace AutoLetterbox
{
    ...
    public class ForceCameraRatio : MonoBehaviour
    {
        ...
        private Q17pD.Frostwatch.Menu.ForcedCameraRatio _forcedCameraRatio;
        ...
        private void Start()
        {
            ...
            TryGetComponent<Q17pD.Frostwatch.Menu.ForcedCameraRatio>(out Q17pD.Frostwatch.Menu.ForcedCameraRatio f);
            _forcedCameraRatio = f;
        }
        ...
        private void Update()
        {
            if (listenForWindowChanges)
            {
                ...
                // if (_forcedCameraRatio != null)
                //     if (!_forcedCameraRatio.enabled)
                //     {
                //         ratio.x = 16;
                //         ratio.y = 9;
                //     }
